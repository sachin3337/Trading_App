    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-4 p-3">
          <h4 className="fs-5 ">
            <i className="fa fa-plus-circle mb-4" aria-hidden="true"></i> Account
            Opening
          </h4>
          <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Online Account Opening</a><br />
          <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Offline Account Opening Company </a><br />
          <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Partnership and HUF Account </a><br />
      ...
      <div className="row mt-5">
        ...
        <div className="col-4 p-3 mb-5">
          ...
          <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Managing your Portfoliol</a><br />
