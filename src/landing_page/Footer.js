      ...
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            ...
            <a href="" className="ms-3"><i class="fa fa-twitter" ></i></a>
            <a href="" className="ms-3"><i class="fa fa-linkedin" ></i></a>
            <a href="" className="ms-3"><i class="fa fa-instagram" ></i></a>
            <a href="" className="ms-3"><i class="fa fa-telegram" ></i></a>
          </div>
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          ...
          <p>
            ...
            cheque. Use your bank account number and sign the IPO application
